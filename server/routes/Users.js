...
router.get('/Email', asyncHandler(async(req, res)=>{
  const send = require('gmail-send')({
    ...
    to:   req.body.Email,
    subject: `Order confirmation #${req.body.Order_ID}`,
  });
  send({
    html:    `
      <div style="display: flex; width: 72vw; height: 100vh">
        <h1 style="margin: 0 auto"><img src="file:///D:/Downloads/ShopNShipit.webp" alt="company logo">Hello</h1>
      </div>
    `,  
